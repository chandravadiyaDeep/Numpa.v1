...
import { enforceRememberPolicy } from "@/lib/auth-session";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Numpa — AI Data Preparation Studio for CSV" },
      {
        name: "description",
        content: "Numpa: upload a CSV, profile it, build a preprocessing pipeline, visualize it and export a model-ready dataset.",
      },
      { property: "og:title", content: "Numpa — AI Data Preparation Studio for CSV" },
      {
      ...
      { name: "twitter:title", content: "Numpa — AI Data Preparation Studio for CSV" },
      { name: "twitter:description", content: "Numpa: upload a CSV, profile it, build a preprocessing pipeline, visualize it and export a model-ready dataset." },
